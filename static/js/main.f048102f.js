...
`,$p=ri.div`
  ...
  align-items: center;
  justify-content: center;
`,Vp=()=>{const{theme:t,toggleTheme:n}=(()=>{const t=(0,e.useContext)(pt);if(void 0===t)throw new Error("useTheme must be used within a ThemeProvider");return t})();return(0,dt.jsx)(Ip,{onClick:n,animate:{scale:[.9,1]},transition:{duration:.3},"aria-label":`Switch to ${"light"===t?"dark":"light"} mode`,children:"light"===t?(0,dt.jsx)($p,{children:(0,dt.jsx)(Fp,{icon:Rp,size:20})}):(0,dt.jsx)($p,{children:(0,dt.jsx)(Fp,{icon:Dp,size:20})})})},Bp="\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n  font-weight: 600;\n  border-radius: 8px;\n  transition: all 0.3s ease;\n  cursor: pointer;\n  text-decoration: none;\n  outline: none;\n  box-shadow: 0 2px 6px var(--shadow);\n\n  &:hover {\n    transform: translateY(-2px);\n    box-shadow: 0 4px 12px var(--shadow);\n  }\n\n  &:active {\n    transform: translateY(0);\n  }\n\n  &:disabled {\n    opacity: 0.6;\n    cursor: not-allowed;\n    transform: none;\n  }\n",Wp=e=>{switch(e){case"primary":return"\n        background-color: var(--accent);\n        color: white;\n        border: none;\n        \n        &:hover {\n          background-color: var(--accent-hover);\n        }\n      ";case"secondary":return"\n        background-color: var(--bg-secondary);\n        color: var(--text-primary);\n        border: none;\n        \n        &:hover {\n          background-color: var(--bg-primary);\n        }\n      ";case"outline":return"\n        background-color: transparent;\n        color: var(--accent);\n        border: 2px solid var(--accent);\n        \n        &:hover {\n          background-color: var(--accent);\n          color: white;\n        }\n      ";case"text":return"\n        background-color: transparent;\n        color: var(--accent);\n        border: none;\n        box-shadow: none;\n        \n        &:hover {\n          color: var(--accent-hover);\n          background-color: rgba(77, 159, 255, 0.1);\n        }\n      ";default:return""}},Up=e=>{switch(e){case"small":return"\n        padding: 0.5rem 1rem;\n        font-size: 0.875rem;\n      ";case"medium":return"\n        padding: 0.75rem 1.5rem;\n        font-size: 1rem;\n      ";case"large":return"\n        padding: 1rem 2rem;\n        font-size: 1.125rem;\n      ";default:return""}},Hp=ri.button`
  ${Bp}
  ${e=>{let{$variant:t}=e;return Wp(t)}}
  ${e=>{let{$size:t}=e;return Up(t)}}
...
`,qp=ri.span`
  ...
  align-items: center;
  justify-content: center;
`,Gp=e=>{let{children:t,variant:n="primary",size:r="medium",icon:i,href:a,to:o,fullWidth:s=!1,...l}=e;const c=(0,dt.jsxs)(dt.Fragment,{children:[i&&(0,dt.jsx)(qp,{children:i}),(0,dt.jsx)("span",{children:t})]});return o?(0,dt.jsx)(Yp,{to:o,$variant:n,$size:r,$fullWidth:s,children:c}):a?(0,dt.jsx)(Kp,{href:a,target:"_blank",rel:"noopener noreferrer",$variant:n,$size:r,$fullWidth:s,children:c}):(0,dt.jsx)(Hp,{$variant:n,$size:r,$fullWidth:s,...l,children:c})},Qp=ri.header`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,dh=()=>{const[t,n]=(0,e.useState)(!1),[r,i]=(0,e.useState)(!1),a=ne();(0,e.useEffect)((()=>{const e=()=>{window.scrollY>20?n(!0):n(!1)};return window.addEventListener("scroll",e),()=>{window.removeEventListener("scroll",e)}}),[]),(0,e.useEffect)((()=>{i(!1)}),[a.pathname]);const o=()=>i(!1),s=e=>"/"===e&&"/"===a.pathname||"/"!==e&&a.pathname.startsWith(e),l=[{name:"Home",path:"/"},{name:"About",path:"/about"},{name:"Projects",path:"/projects"},{name:"Skills",path:"/skills"},{name:"Contact",path:"/contact"}];return(0,dt.jsx)(Qp,{isScrolled:t,children:(0,dt.jsxs)(Xp,{children:[(0,dt.jsx)(Jp,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.5},children:(0,dt.jsx)(Zp,{to:"/",onClick:e=>{"/"===window.location.pathname&&(e.preventDefault(),window.scrollTo({top:0,behavior:"smooth"}))},children:"SH"})}),(0,dt.jsx)(eh,{children:(0,dt.jsx)(th,{children:l.map(((e,t)=>(0,dt.jsx)(nh,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.1*t},children:(0,dt.jsx)(rh,{to:e.path,onClick:o,$isActive:s(e.path),children:e.name})},e.name)))})}),(0,dt.jsxs)(ih,{children:[(0,dt.jsx)(ah,{as:ep.div,initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.5},children:(0,dt.jsx)(oh,{href:"/files/Suren's Resume - Frontend Software Engineer.pdf",download:"Suren's Resume - Frontend Software Engineer.pdf",children:(0,dt.jsx)(Gp,{size:"small",variant:"primary",icon:(0,dt.jsx)(xp,{size:16}),children:"Download CV"})})}),(0,dt.jsx)(Vp,{}),(0,dt.jsx)(sh,{onClick:()=>i(!r),children:r?(0,dt.jsx)(Fp,{icon:Np,size:24}):(0,dt.jsx)(Fp,{icon:Tp,size:24})})]}),(0,dt.jsx)(sp,{children:r&&(0,dt.jsx)(lh,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.3},children:(0,dt.jsxs)(ch,{children:[l.map(((e,t)=>(0,dt.jsx)(uh,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.3,delay:.05*t},children:(0,dt.jsx)(rh,{to:e.path,onClick:o,$isActive:s(e.path),children:e.name})},e.name))),(0,dt.jsx)(uh,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.3,delay:.25},children:(0,dt.jsx)(oh,{href:"/files/Suren's Resume - Frontend Software Engineer.pdf",download:"Suren's Resume - Frontend Software Engineer.pdf",children:(0,dt.jsx)(Gp,{size:"small",variant:"primary",icon:(0,dt.jsx)(xp,{size:16}),fullWidth:!0,children:"Download CV"})})})]})})})]})})},ph=ri(ep.button)`
  position: fixed;
  bottom: 30px;
  right: 30px;
  width: 50px;
...
`,hh=()=>{const[t,n]=(0,e.useState)(!1);(0,e.useEffect)((()=>{const e=()=>{window.scrollY>300?n(!0):n(!1)};return window.addEventListener("scroll",e),()=>window.removeEventListener("scroll",e)}),[]);return(0,dt.jsx)(sp,{children:t&&(0,dt.jsx)(ph,{onClick:()=>{window.scrollTo({top:0,behavior:"smooth"})},initial:{opacity:0,scale:.5},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.5},whileHover:{scale:1.1},whileTap:{scale:.9},children:(0,dt.jsx)(mp,{size:20})})})},fh=()=>{const{pathname:t}=ne();return(0,e.useEffect)((()=>{window.scrollTo(0,0)}),[t]),null},mh=t=>{const[n,r]=(0,e.useState)(!1);return(0,e.useEffect)((()=>{const e=window.matchMedia(t);r(e.matches);const n=e=>{r(e.matches)};return e.addEventListener("change",n),()=>{e.removeEventListener("change",n)}}),[t]),n},gh=function(){return mh(`(max-width: ${arguments.length>0&&void 0!==arguments[0]?arguments[0]:768}px)`)},vh=ri.div`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
`,Th=ri.div`
  width: 100%;
`,jh=e=>{let{id:t,title:n,subtitle:r,children:i,fullWidth:a=!1,className:o,noPaddingTop:s=!1,style:l}=e;const c={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3}}};return(0,dt.jsx)(wh,{id:t,className:o,as:ep.section,initial:"initial",animate:"animate",variants:{initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,staggerChildren:.1}}},noPaddingTop:s,style:l,children:(0,dt.jsxs)(Sh,{fullWidth:a,children:[(n||r)&&(0,dt.jsxs)(kh,{children:[n&&(0,dt.jsx)(Eh,{as:ep.h2,variants:c,children:n}),r&&(0,dt.jsx)(Ch,{as:ep.p,variants:c,children:r}),(0,dt.jsx)(Ph,{as:ep.div,variants:c})]}),(0,dt.jsx)(Th,{as:ep.div,variants:c,children:i})]})})},Rh=(e,t)=>{const n=new Date(e,t-1),r=new Date;let i=r.getFullYear()-n.getFullYear();return(r.getMonth()<n.getMonth()||r.getMonth()===n.getMonth()&&r.getDate()<n.getDate())&&i--,`${i}+`},Ah=2018,Lh=9,zh=ri.div`
  position: relative;
`,Mh=ri.section`
...
`,ff=()=>{const t=Rh(Ah,Lh);(0,e.useEffect)((()=>{window.scrollTo(0,0),"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual")}),[]);const n={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.6}}},r=[{name:"Email",icon:Cp,url:"mailto:surhak96@gmail.com"},{name:"LinkedIn",icon:Ep,url:"https://linkedin.com/in/surhak"},{name:"Telegram",icon:zp,url:"https://t.me/surohak"},{name:"GitHub",icon:Sp,url:"https://github.com/surohak"}],i=[{title:"Years of Experience",value:t,icon:"\ud83d\ude80",description:"Frontend development journey"},{title:"Projects Completed",value:"20+",icon:"\ud83d\udcbc",description:"Across various industries"},{title:"Technologies",value:"25+",icon:"\u2699\ufe0f",description:"Framework & library expertise"},{title:"Client Satisfaction",value:"100%",icon:"\u2728",description:"Delivering quality solutions"}];return(0,dt.jsxs)(zh,{children:[(0,dt.jsx)(bh,{}),(0,dt.jsx)(Mh,{children:(0,dt.jsxs)(Dh,{as:ep.div,variants:{hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.2}}},initial:"hidden",animate:"visible",children:[(0,dt.jsxs)(_h,{variants:n,children:["Hello ",(0,dt.jsx)(Oh,{children:"\ud83d\udc4b"})," I'm"]}),(0,dt.jsx)(Nh,{variants:n,children:"Suren Hakobyan"}),(0,dt.jsx)(Fh,{variants:n,children:"Frontend Software Engineer"}),(0,dt.jsxs)(Ih,{variants:n,children:["I specialize in building high-performance web applications and interactive user interfaces. With ",t," years of experience in modern frontend technologies, I deliver polished, user-centric solutions with a focus on performance and maintainability."]}),(0,dt.jsx)($h,{variants:n,children:["Frontend Architecture","JavaScript & TypeScript","React & Next.js","Vue & Nuxt.js","WebGL & Canvas","Electron.js & React Native","Responsive Design & UI/UX","Performance Optimization"].map(((e,t)=>(0,dt.jsx)(Vh,{children:e},t)))}),(0,dt.jsxs)(Bh,{variants:n,children:[(0,dt.jsx)(Wh,{to:"/projects",children:"View My Work"}),(0,dt.jsx)(Uh,{to:"/contact",children:"Get In Touch"})]}),(0,dt.jsx)(Hh,{variants:n,children:r.map((e=>(0,dt.jsxs)(Yh,{href:e.url,target:"Email"===e.name?"_self":"_blank",rel:"noopener noreferrer",children:[(0,dt.jsx)(Fp,{icon:e.icon,size:24})," ",e.name]},e.name)))})]})}),(0,dt.jsx)(Zh,{children:(0,dt.jsx)(jh,{id:"key-highlights",title:"Key Highlights",subtitle:"Numbers that reflect my professional journey",noPaddingTop:!0,style:{position:"relative",zIndex:1},children:(0,dt.jsx)(ef,{children:i.map(((e,t)=>(0,dt.jsxs)(rf,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.5,delay:.1*t},viewport:{once:!0},children:[(0,dt.jsx)(tf,{children:e.icon}),(0,dt.jsx)(nf,{children:e.value}),(0,dt.jsx)(af,{children:e.title}),(0,dt.jsx)(of,{children:e.description})]},t)))})})}),(0,dt.jsx)(sf,{children:(0,dt.jsxs)(lf,{children:[(0,dt.jsxs)(cf,{children:["Looking for a ",(0,dt.jsx)("span",{children:"Skilled Frontend Engineer"}),"?"]}),(0,dt.jsxs)(uf,{children:["With ",t," years of experience building performant, responsive and visually appealing web applications, I'm ready to bring value to your team from day one."]}),(0,dt.jsxs)(df,{children:[(0,dt.jsx)(pf,{href:"/files/Suren's Resume - Frontend Software Engineer.pdf",target:"_blank",rel:"noopener noreferrer",children:"View My Resume"}),(0,dt.jsx)(hf,{href:"https://calendly.com/surhak",target:"_blank",rel:"noopener noreferrer",children:"Schedule a Call"})]})]})}),(0,dt.jsx)(Kh,{children:(0,dt.jsx)(jh,{id:"about-preview",title:"About Me",subtitle:"Frontend Engineer with expertise in modern web technologies",children:(0,dt.jsxs)(qh,{children:[(0,dt.jsx)(Gh,{src:"/suren.jpg",alt:"Suren Hakobyan"}),(0,dt.jsxs)(Qh,{children:[(0,dt.jsxs)("p",{children:["I'm a Frontend Software Engineer with ",t," years of experience in developing complex web applications. I've worked with leading companies like Simplified, JobLeads, and Picsart to create innovative user interfaces and interactive experiences."]}),(0,dt.jsx)("p",{children:"My approach combines technical expertise with a passion for creating intuitive and engaging user experiences. I excel at translating design concepts into performant code that balances aesthetics with functionality."}),(0,dt.jsx)("p",{children:"With a strong foundation in JavaScript, TypeScript, React, Vue.js, and various frontend frameworks, I take pride in building scalable solutions that solve real-world problems."}),(0,dt.jsx)(Xh,{children:(0,dt.jsx)(Wh,{to:"/about",style:{zIndex:10,position:"relative"},children:"Learn More About Me"})})]})]})})}),(0,dt.jsx)(Jh,{children:(0,dt.jsxs)("p",{children:["\xa9 ",(new Date).getFullYear()," Suren Hakobyan. All Rights Reserved."]})})]})};function mf(e,t){let n;const r=()=>{const{currentTime:r}=t,i=(null===r?0:r.value)/100;n!==i&&e(i),n=i};return Ui.update(r,!0),()=>Hi(r)}const gf=new WeakMap;let vf;function yf(e){let{target:t,contentRect:n,borderBoxSize:r}=e;gf.get(t)?.forEach((e=>{e({target:t,contentSize:n,get size(){return function(e,t){if(t){const{inlineSize:e,blockSize:n}=t[0];return{width:e,height:n}}return e instanceof SVGElement&&"getBBox"in e?e.getBBox():{width:e.offsetWidth,height:e.offsetHeight}}(t,r)}})}))}function xf(e){e.forEach(yf)}function bf(e,t){vf||"undefined"!==typeof ResizeObserver&&(vf=new ResizeObserver(xf));const n=ta(e);return n.forEach((e=>{let n=gf.get(e);n||(n=new Set,gf.set(e,n)),n.add(t),vf?.observe(e)})),()=>{n.forEach((e=>{const n=gf.get(e);n?.delete(t),n?.size||vf?.unobserve(e)}))}}const wf=new Set;let Sf;function kf(e){return wf.add(e),Sf||(Sf=()=>{const e={width:window.innerWidth,height:window.innerHeight},t={target:window,size:e,contentSize:e};wf.forEach((e=>e(t)))},window.addEventListener("resize",Sf)),()=>{wf.delete(e),!wf.size&&Sf&&(Sf=void 0)}}const Ef={x:{length:"Width",position:"Left"},y:{length:"Height",position:"Top"}};function Cf(e,t,n,r){const i=n[t],{length:a,position:o}=Ef[t],s=i.current,l=n.time;i.current=e[`scroll${o}`],i.scrollLength=e[`scroll${a}`]-e[`client${a}`],i.offset.length=0,i.offset[0]=0,i.offset[1]=i.scrollLength,i.progress=pi(0,i.scrollLength,i.current);const c=r-l;i.velocity=c>50?0:gi(i.current-s,c)}const Pf={start:0,center:.5,end:1};function Tf(e,t){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,r=0;if(e in Pf&&(e=Pf[e]),"string"===typeof e){const t=parseFloat(e);e.endsWith("px")?r=t:e.endsWith("%")?e=t/100:e.endsWith("vw")?r=t/100*document.documentElement.clientWidth:e.endsWith("vh")?r=t/100*document.documentElement.clientHeight:e=t}return"number"===typeof e&&(r=t*e),n+r}const jf=[0,0];function Rf(e,t,n,r){let i=Array.isArray(e)?e:jf,a=0,o=0;return"number"===typeof e?i=[e,e]:"string"===typeof e&&(i=(e=e.trim()).includes(" ")?e.split(" "):[e,Pf[e]?e:"0"]),a=Tf(i[0],n,r),o=Tf(i[1],t),a-o}const Af={Enter:[[0,1],[1,1]],Exit:[[0,0],[1,0]],Any:[[1,0],[0,1]],All:[[0,0],[1,1]]},Lf={x:0,y:0};function zf(e,t,n){const{offset:r=Af.All}=n,{target:i=e,axis:a="y"}=n,o="y"===a?"height":"width",s=i!==e?function(e,t){const n={x:0,y:0};let r=e;for(;r&&r!==t;)if(r instanceof HTMLElement)n.x+=r.offsetLeft,n.y+=r.offsetTop,r=r.offsetParent;else if("svg"===r.tagName){const e=r.getBoundingClientRect();r=r.parentElement;const t=r.getBoundingClientRect();n.x+=e.left-t.left,n.y+=e.top-t.top}else{if(!(r instanceof SVGGraphicsElement))break;{const{x:e,y:t}=r.getBBox();n.x+=e,n.y+=t;let i=null,a=r.parentNode;for(;!i;)"svg"===a.tagName&&(i=a),a=r.parentNode;r=i}}return n}(i,e):Lf,l=i===e?{width:e.scrollWidth,height:e.scrollHeight}:function(e){return"getBBox"in e&&"svg"!==e.tagName?e.getBBox():{width:e.clientWidth,height:e.clientHeight}}(i),c={width:e.clientWidth,height:e.clientHeight};t[a].offset.length=0;let u=!t[a].interpolate;const d=r.length;for(let p=0;p<d;p++){const e=Rf(r[p],c[o],l[o],s[a]);u||e===t[a].interpolatorOffsets[p]||(u=!0),t[a].offset[p]=e}u&&(t[a].interpolate=Ws(t[a].offset,Us(r),{clamp:!1}),t[a].interpolatorOffsets=[...t[a].offset]),t[a].progress=Ia(0,1,t[a].interpolate(t[a].current))}function Mf(e,t,n){let r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{};return{measure:()=>function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:e,n=arguments.length>2?arguments[2]:void 0;if(n.x.targetOffset=0,n.y.targetOffset=0,t!==e){let r=t;for(;r&&r!==e;)n.x.targetOffset+=r.offsetLeft,n.y.targetOffset+=r.offsetTop,r=r.offsetParent}n.x.targetLength=t===e?t.scrollWidth:t.clientWidth,n.y.targetLength=t===e?t.scrollHeight:t.clientHeight,n.x.containerLength=e.clientWidth,n.y.containerLength=e.clientHeight}(e,r.target,n),update:t=>{!function(e,t,n){Cf(e,"x",t,n),Cf(e,"y",t,n),t.time=n}(e,n,t),(r.offset||r.target)&&zf(e,n,r)},notify:()=>t(n)}}const Df=new WeakMap,_f=new WeakMap,Of=new WeakMap,Nf=e=>e===document.documentElement?window:e;function Ff(e){let{container:t=document.documentElement,...n}=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=Of.get(t);r||(r=new Set,Of.set(t,r));const i=Mf(t,e,{time:0,x:{current:0,offset:[],progress:0,scrollLength:0,targetOffset:0,targetLength:0,containerLength:0,velocity:0},y:{current:0,offset:[],progress:0,scrollLength:0,targetOffset:0,targetLength:0,containerLength:0,velocity:0}},n);if(r.add(i),!Df.has(t)){const e=()=>{for(const e of r)e.measure()},n=()=>{for(const e of r)e.update(Yi.timestamp)},i=()=>{for(const e of r)e.notify()},a=()=>{Ui.read(e,!1,!0),Ui.read(n,!1,!0),Ui.update(i,!1,!0)};Df.set(t,a);const o=Nf(t);window.addEventListener("resize",a,{passive:!0}),t!==document.documentElement&&_f.set(t,function(e,t){return"function"===typeof e?kf(e):bf(e,t)}(t,a)),o.addEventListener("scroll",a,{passive:!0})}const a=Df.get(t);return Ui.read(a,!1,!0),()=>{Hi(a);const e=Of.get(t);if(!e)return;if(e.delete(i),e.size)return;const n=Df.get(t);Df.delete(t),n&&(Nf(t).removeEventListener("scroll",n),_f.get(t)?.(),window.removeEventListener("resize",n))}}const If=new Map;function $f(){let{source:e,container:t=document.documentElement,axis:n="y"}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};e&&(t=e),If.has(t)||If.set(t,{});const r=If.get(t);return r[n]||(r[n]=Si()?new ScrollTimeline({source:t,axis:n}):function(e){let{source:t,container:n,axis:r="y"}=e;t&&(n=t);const i={value:0},a=Ff((e=>{i.value=100*e[r].progress}),{container:n,axis:r});return{currentTime:i,cancel:a}}({source:t,axis:n})),r[n]}function Vf(e){return e&&(e.target||e.offset)}function Bf(e){let{axis:t="y",...n}=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};const r={axis:t,...n};return"function"===typeof e?function(e,t){return function(e){return 2===e.length}(e)||Vf(t)?Ff((n=>{e(n[t.axis].progress,n)}),t):mf(e,$f(t))}(e,r):function(e,t){if(e.flatten(),Vf(t))return e.pause(),Ff((n=>{e.time=e.duration*n[t.axis].progress}),t);{const n=$f(t);return e.attachTimeline?e.attachTimeline(n,(e=>(e.pause(),mf((t=>{e.time=e.duration*t}),n)))):di}}(e,r)}function Wf(e,t){Boolean(!t||t.current)}const Uf=()=>({scrollX:fa(0),scrollY:fa(0),scrollXProgress:fa(0),scrollYProgress:fa(0)});const Hf=e=>(e=>e&&"object"===typeof e&&e.mix)(e)?e.mix:void 0;function Yf(t,n){const r=function(t){const n=zd((()=>fa(t))),{isStatic:r}=(0,e.useContext)(Ku);if(r){const[,r]=(0,e.useState)(t);(0,e.useEffect)((()=>n.on("change",r)),[])}return n}(n()),i=()=>r.set(n());return i(),id((()=>{const e=()=>Ui.preRender(i,!1,!0),n=t.map((t=>t.on("change",e)));return()=>{n.forEach((e=>e())),Hi(i)}})),r}function Kf(e,t,n,r){if("function"===typeof e)return function(e){pa.current=[],e();const t=Yf(pa.current,e);return pa.current=void 0,t}(e);const i="function"===typeof t?t:function(){const e=!Array.isArray(arguments.length<=0?void 0:arguments[0]),t=e?0:-1,n=0+t<0||arguments.length<=0+t?void 0:arguments[0+t],r=2+t<0||arguments.length<=2+t?void 0:arguments[2+t],i=3+t<0||arguments.length<=3+t?void 0:arguments[3+t],a=Ws(1+t<0||arguments.length<=1+t?void 0:arguments[1+t],r,{mixer:Hf(r[0]),...i});return e?a(n):a}(t,n,r);return Array.isArray(e)?qf(e,i):qf([e],(e=>{let[t]=e;return i(t)}))}function qf(e,t){const n=zd((()=>[]));return Yf(e,(()=>{n.length=0;const r=e.length;for(let t=0;t<r;t++)n[t]=e[t].get();return t(n)}))}const Gf=ri.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Xf=ri(ep.div)`
  ...
  opacity: 0.015;
  z-index: 1;
`,Jf=t=>{let{variant:n="about"}=t;const[r,i]=(0,e.useState)(0),{scrollY:a}=function(){let{container:t,target:n,layoutEffect:r=!0,...i}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};const a=zd(Uf);return(r?id:e.useEffect)((()=>(Wf(0,n),Wf(0,t),Bf(((e,t)=>{let{x:n,y:r}=t;a.scrollX.set(n.current),a.scrollXProgress.set(n.progress),a.scrollY.set(r.current),a.scrollYProgress.set(r.progress)}),{...i,container:t?.current||void 0,target:n?.current||void 0}))),[t,n,JSON.stringify(i.offset)]),a}(),o=gh();(0,e.useEffect)((()=>{const e=()=>{i(window.innerHeight)};return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)}),[]);const s=Kf(a,[0,2*r],[0,o?180:360]),l=Kf(a,[0,r],[0,o?25:50]),c=Kf(a,[0,r],[0,o?-15:-30]),u=Kf(a,[0,1.5*r],[1,o?1.1:1.2]),d=Kf(a,[0,2*r],[0,o?-180:-360]),p=Kf(a,[0,r],[0,o?-20:-40]),h=Kf(a,[0,r],[0,o?10:20]),f=Kf(a,[0,1.5*r],[1,o?.9:.8]),m=Kf(a,[0,r],[.01,.02]),g=()=>{switch(n){case"about":default:return"var(--accent)";case"projects":return"#6366f1";case"skills":return"#10b981";case"contact":return"#f59e0b"}};return(0,dt.jsxs)(Gf,{children:[(0,dt.jsx)(Qf,{style:{rotate:s,x:l,y:c,scale:u},animate:o?{filter:["blur(80px)","blur(90px)"]}:{filter:["blur(100px)","blur(120px)","blur(90px)"]},transition:{filter:{duration:o?4:5,repeat:1/0,repeatType:"reverse"}},blurRadius:o?80:100,color:g(),opacity:.04,size:o?400:500,top:"5%",right:"10%"}),!o&&(0,dt.jsx)(Qf,{style:{rotate:d,x:p,y:h,scale:f},animate:{filter:["blur(120px)","blur(100px)","blur(140px)"]},transition:{filter:{duration:8,repeat:1/0,repeatType:"reverse"}},blurRadius:120,color:g(),opacity:.03,size:600,bottom:"10%",left:"5%"}),(0,dt.jsx)(Xf,{style:{opacity:m}})]})},Zf=(ri.span`
  font-weight: 600;
  color: var(--text-primary);
`,ri.div`
  position: relative;
...
`,nm=e=>["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][e-1],rm=ri.div`
  display: flex;
  justify-content: center;
  margin-top: 0.8rem;
`,im=t=>{let{job:n}=t;const[r,i]=e.useState(!1),a="Freelance / Contract / Self-Employed"===n.company,{visibleTechs:o,remainingCount:s}=(()=>{const e=["JavaScript","TypeScript","React.js","Vue.js","Next.js","Nuxt.js","HTML5 Canvas","Fabric.js","Konva.js","Redux.js","WebSocket","GraphQL","Electron.js","React Native","Qt QML"],t=[...n.technologies].sort(((t,n)=>{const r=e.indexOf(t),i=e.indexOf(n);return-1!==r&&-1!==i?r-i:-1!==r?-1:-1!==i?1:t.localeCompare(n)}));return r?{visibleTechs:t,remainingCount:0}:{visibleTechs:t.slice(0,4),remainingCount:t.length-4}})(),l=()=>{i(!r)};return(0,dt.jsxs)(Zf,{children:[(0,dt.jsx)(Em,{children:(()=>{const e=`${nm(n.startMonth)} ${n.startYear}`,t=n.endYear?`${nm(n.endMonth)} ${n.endYear}`:"Present",r=((e,t,n,r)=>{const i=new Date;let a=12*((n||i.getFullYear())-e)+((r||i.getMonth()+1)-t+1);const o=Math.floor(a/12),s=a%12;return 0===o?`${s} ${1===s?"mo":"mos"}`:0===s?`${o} ${1===o?"yr":"yrs"}`:`${o} ${1===o?"yr":"yrs"} ${s} ${1===s?"mo":"mos"}`})(n.startYear,n.startMonth,n.endYear,n.endMonth);return`${e} - ${t} \xb7 ${r}`})()}),(0,dt.jsxs)(Cm,{children:[(0,dt.jsxs)(Ym,{children:[a?(0,dt.jsx)(tm,{children:"SH"}):(0,dt.jsx)(Km,{children:(0,dt.jsx)("img",{src:em[n.company],alt:`${n.company} logo`})}),(0,dt.jsxs)(qm,{children:[(0,dt.jsx)(Pm,{children:n.position}),(0,dt.jsxs)(Tm,{children:[n.website?(0,dt.jsxs)(Um,{href:n.website,target:"_blank",rel:"noopener noreferrer",children:[n.company," ",(0,dt.jsx)(Hm,{})]}):n.company,n.location&&(0,dt.jsx)(jm,{children:n.location})]})]})]}),(0,dt.jsxs)(Rm,{children:[n.description.length>0&&(0,dt.jsx)(Qm,{dangerouslySetInnerHTML:{__html:om(n.description[0])}}),n.description.length>1&&(0,dt.jsx)(Am,{children:n.description.slice(1).map(((e,t)=>(0,dt.jsx)(Lm,{dangerouslySetInnerHTML:{__html:om(e)}},t)))})]}),(0,dt.jsx)(zm,{children:"Technologies & Skills"}),(0,dt.jsxs)(Mm,{children:[o.map(((e,t)=>(0,dt.jsx)(Dm,{index:t,children:e},t))),s>0&&(0,dt.jsxs)(_m,{onClick:l,children:["+",s," more"]})]}),r&&(0,dt.jsx)(rm,{children:(0,dt.jsx)(_m,{onClick:l,children:"Show less"})})]})]})},am=e=>{let{workExperience:t}=e;return(0,dt.jsxs)(bm,{children:[(0,dt.jsx)(Wm,{children:"Work Experience"}),(0,dt.jsx)(km,{children:t.map(((e,t)=>(0,dt.jsx)(im,{job:e},t)))})]})},om=e=>e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),sm=ri.div`
  padding: 2rem 0;
...
`,bm=ri.div``,wm=ri.div``,Sm=ri.div``,km=ri.div`
  position: relative;
...
`,Xm=()=>{const e=Rh(Ah,Lh),t=[{icon:_p,label:"Name",value:"Suren Hakobyan"},{icon:gp,label:"Experience",value:`${e} Years`},{icon:Pp,label:"Location",value:"Yerevan, Armenia",link:"https://www.google.com/maps/place/Yerevan,+Armenia"},{icon:yp,label:"Languages",value:"JavaScript (ES6+), TypeScript, HTML5/CSS3, WebGL, Canvas API"},{icon:kp,label:"Specialization",value:"Frontend Software Engineer"},{icon:Op,label:"Collaboration",value:"Local and Remote teams across time zones"}],n={"Yerevan State University":"https://media.licdn.com/dms/image/v2/C4E0BAQHWAaYmV_OWSA/company-logo_100_100/company-logo_100_100/0/1631358097750?e=1750291200&v=beta&t=XergHzwN7CYzrniRpWbtereWekgN843RPy4Nai0s6-c"},r=e=>{let{edu:t}=e;return(0,dt.jsxs)(Zf,{children:[(0,dt.jsx)(Em,{children:`${nm(t.startMonth)} ${t.startYear} - ${t.endYear?`${nm(t.endMonth)} ${t.endYear}`:"Present"}`}),(0,dt.jsxs)(Cm,{children:[(0,dt.jsxs)(Ym,{children:[(0,dt.jsx)(Km,{children:(0,dt.jsx)("img",{src:(r=t.institution,n[r]||"/education-default.png"),alt:`${t.institution} logo`})}),(0,dt.jsxs)(qm,{children:[(0,dt.jsx)(Pm,{children:t.degree}),(0,dt.jsx)(Tm,{children:t.institution})]})]}),(0,dt.jsx)(Rm,{children:t.description})]})]});var r},i=e=>{let{info:t,index:n}=e;return(0,dt.jsxs)(fm,{children:[(0,dt.jsx)(mm,{children:(0,dt.jsx)(Fp,{icon:t.icon,size:20})}),(0,dt.jsxs)(gm,{children:[(0,dt.jsxs)(vm,{children:[t.label,":"]}),t.link?(0,dt.jsx)(ym,{children:(0,dt.jsxs)(a,{href:t.link,target:"_blank",rel:"noopener noreferrer",children:[t.value," ",(0,dt.jsx)(Hm,{})]})}):(0,dt.jsx)(ym,{children:t.value})]})]},n)},a=ri.a`
    color: var(--accent);
    text-decoration: none;
    display: inline-flex;
    align-items: center;
...
`,sg=ri.div`
  ...
  z-index: 1;
  padding: 0 1rem;
  animation: ${ag} 2s infinite ease-in-out;
...
`,ug=ri.div`
  ...
  height: 100%;
  background-color: var(--accent);
  animation: ${og} 1.5s infinite ease-in-out;
`,dg=ri.div`
  position: absolute;
  inset: 0;
...
`,ev=()=>{const t=Ag.find((e=>"Main Technologies"===e.title)),n=Ag.find((e=>"Professional Skills"===e.title)),r=Ag.filter((e=>"Main Technologies"!==e.title&&"Professional Skills"!==e.title)),i=gh(),a={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:i?.05:.1}}},o={hidden:{opacity:0,y:20},visible:{opacity:1,y:0,transition:{duration:i?.3:.4}}},s=function(t,n){let r=arguments.length>2&&void 0!==arguments[2]&&arguments[2];return(0,dt.jsxs)(_g,{as:ep.div,variants:o,className:r?"full-width-category":"",children:[(0,dt.jsxs)(Og,{children:[(0,dt.jsx)(Ng,{children:e.cloneElement(t.icon,{size:i?20:24})}),(0,dt.jsx)(Fg,{children:t.title})]}),(0,dt.jsx)(Ig,{className:r?"full-width-skills":"",children:t.skills.map(((e,t)=>(0,dt.jsxs)($g,{children:[(0,dt.jsx)(Vg,{children:e.name}),(0,dt.jsx)(Bg,{children:(0,dt.jsx)(Wg,{as:ep.div,initial:{width:0},animate:{width:`${e.level}%`},transition:{duration:i?.7:1,delay:i?.05+.03*t:.1+.05*t},level:e.level})}),(0,dt.jsxs)(Ug,{children:[e.level,"%"]})]},t)))})]},n)};return(0,dt.jsxs)(Lg,{children:[(0,dt.jsx)(Jf,{variant:"skills"}),(0,dt.jsxs)(jh,{id:"skills",title:"Skills & Expertise",subtitle:"A comprehensive overview of my technical abilities",children:[(0,dt.jsx)(zg,{children:"I specialize in modern frontend technologies with a focus on interactive applications, canvas-based editors, and high-performance web solutions. My experience spans across various frameworks, libraries, and platforms, enabling me to deliver robust and user-friendly applications."}),(0,dt.jsxs)(Mg,{children:[t&&(0,dt.jsx)(Zg,{children:s(t,0,!0)}),(0,dt.jsx)(Dg,{as:ep.div,variants:a,initial:"hidden",animate:"visible",children:r.map(((e,t)=>s(e,t)))}),n&&(0,dt.jsx)(Zg,{children:s(n,r.length+1,!0)}),(0,dt.jsxs)(Hg,{as:ep.div,initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:i?.4:.5,delay:.3},children:[(0,dt.jsxs)(Yg,{children:[(0,dt.jsx)(Fp,{icon:Mp,size:i?20:24}),(0,dt.jsx)("h3",{children:"My Working Process"})]}),(0,dt.jsxs)(Kg,{children:[(0,dt.jsxs)(qg,{children:[(0,dt.jsx)(Gg,{children:(0,dt.jsx)(Fp,{icon:vp,size:i?20:24})}),(0,dt.jsxs)(Qg,{children:[(0,dt.jsx)(Xg,{children:"Research & Understanding Requirements"}),(0,dt.jsx)(Jg,{children:"I begin by understanding business requirements and translating them into technical requirements. I research solutions and plan the architecture to ensure a solid foundation."})]})]}),(0,dt.jsxs)(qg,{children:[(0,dt.jsx)(Gg,{children:(0,dt.jsx)(Fp,{icon:yp,size:i?20:24})}),(0,dt.jsxs)(Qg,{children:[(0,dt.jsx)(Xg,{children:"Design & Development"}),(0,dt.jsx)(Jg,{children:"I design intuitive interfaces and develop clean, efficient code following best practices. I specialize in working with Canvas element for image/video processing and creating interactive web applications."})]})]}),(0,dt.jsxs)(qg,{children:[(0,dt.jsx)(Gg,{children:(0,dt.jsx)(Fp,{icon:wp,size:i?20:24})}),(0,dt.jsxs)(Qg,{children:[(0,dt.jsx)(Xg,{children:"Code Review & Testing"}),(0,dt.jsx)(Jg,{children:"I conduct daily code reviews to maintain code quality and ensure best practices. I work with QA to isolate and fix bugs, and implement unit, integration, and E2E tests for reliability."})]})]}),(0,dt.jsxs)(qg,{children:[(0,dt.jsx)(Gg,{children:(0,dt.jsx)(Fp,{icon:jp,size:i?20:24})}),(0,dt.jsxs)(Qg,{children:[(0,dt.jsx)(Xg,{children:"Deployment & Optimization"}),(0,dt.jsx)(Jg,{children:"After deployment, I optimize user experience by implementing interactive, dynamic UX solutions. I focus on performance optimization and provide ongoing support and maintenance."})]})]})]})]})]})]})]})},tv={_origin:"https://api.emailjs.com"},nv=(e,t,n)=>{if(!e)throw"The user ID is required. Visit https://dashboard.emailjs.com/admin/integration";if(!t)throw"The service ID is required. Visit https://dashboard.emailjs.com/admin";if(!n)throw"The template ID is required. Visit https://dashboard.emailjs.com/admin/templates";return!0};class rv{constructor(e){this.status=e.status,this.text=e.responseText}}const iv=function(e,t){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{};return new Promise(((r,i)=>{const a=new XMLHttpRequest;a.addEventListener("load",(e=>{let{target:t}=e;const n=new rv(t);200===n.status||"OK"===n.text?r(n):i(n)})),a.addEventListener("error",(e=>{let{target:t}=e;i(new rv(t))})),a.open("POST",tv._origin+e,!0),Object.keys(n).forEach((e=>{a.setRequestHeader(e,n[e])})),a.send(t)}))},av=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"https://api.emailjs.com";tv._userID=e,tv._origin=t},ov=(e,t,n,r)=>{const i=r||tv._userID,a=(e=>{let t;if(t="string"===typeof e?document.querySelector(e):e,!t||"FORM"!==t.nodeName)throw"The 3rd parameter is expected to be the HTML form element or the style selector of form";return t})(n);nv(i,e,t);const o=new FormData(a);return o.append("lib_version","3.2.0"),o.append("service_id",e),o.append("template_id",t),o.append("user_id",i),iv("/api/v1.0/email/send-form",o)},sv=ri.div`
  padding-top: 100px;
...
`,Iv=()=>{const t=(0,e.useRef)(null),[n,r]=(0,e.useState)({from_name:"",reply_to:"",subject:"",message:""}),i=gh(),a=Rh(Ah,Lh);(0,e.useEffect)((()=>{av("mitFBwd43Ky99sQf6")}),[]);const[o,s]=(0,e.useState)("idle"),l=e=>{const{name:t,value:n}=e.target;r((e=>({...e,[t]:n})))};return(0,dt.jsxs)(sv,{children:[(0,dt.jsx)(Jf,{variant:"contact"}),(0,dt.jsx)(zv,{children:(0,dt.jsxs)(Mv,{children:[(0,dt.jsxs)(Dv,{children:["Need a ",(0,dt.jsx)("span",{children:"Frontend Engineer"})," for Your Team?"]}),(0,dt.jsxs)(_v,{children:["I'm available for interviews and can respond quickly. With ",a," years of experience building high-performance web applications, I can help bring your projects to life."]}),(0,dt.jsxs)(Ov,{children:[(0,dt.jsx)(Nv,{href:"/files/Suren's Resume - Frontend Software Engineer.pdf",target:"_blank",rel:"noopener noreferrer",children:"View My Resume"}),(0,dt.jsx)(Fv,{href:"https://calendly.com/surhak",target:"_blank",rel:"noopener noreferrer",children:"Schedule a Call"})]})]})}),(0,dt.jsx)(jh,{id:"contact",title:"Get In Touch",subtitle:"Have a question or want to work together? Reach out to me!",children:(0,dt.jsxs)(lv,{children:[(0,dt.jsxs)(cv,{as:ep.div,initial:{opacity:0,x:i?-15:-30},animate:{opacity:1,x:0},transition:{duration:i?.4:.5},children:[(0,dt.jsx)(uv,{children:"Contact Information"}),(0,dt.jsx)(dv,{children:"Fill out the form or get in touch directly using the information below."}),(0,dt.jsxs)(pv,{children:[(0,dt.jsxs)(hv,{children:[(0,dt.jsx)(fv,{children:(0,dt.jsx)(Cp,{size:i?18:20})}),(0,dt.jsxs)(mv,{children:[(0,dt.jsx)(gv,{children:"Email"}),(0,dt.jsx)(vv,{children:(0,dt.jsx)(yv,{href:"mailto:surhak96@gmail.com",children:"surhak96@gmail.com"})})]})]}),(0,dt.jsxs)(hv,{children:[(0,dt.jsx)(fv,{children:(0,dt.jsx)(Ap,{size:i?18:20})}),(0,dt.jsxs)(mv,{children:[(0,dt.jsx)(gv,{children:"Phone"}),(0,dt.jsx)(vv,{children:(0,dt.jsx)(yv,{href:"tel:+37495222706",children:"+374 95 222 706"})})]})]}),(0,dt.jsxs)(hv,{children:[(0,dt.jsx)(fv,{children:(0,dt.jsx)(Pp,{size:i?18:20})}),(0,dt.jsxs)(mv,{children:[(0,dt.jsx)(gv,{children:"Location"}),(0,dt.jsx)(vv,{children:(0,dt.jsx)(yv,{href:"https://www.google.com/maps/place/Yerevan,+Armenia",target:"_blank",rel:"noopener noreferrer",children:"Yerevan, Armenia"})})]})]})]}),(0,dt.jsxs)(xv,{children:[(0,dt.jsx)(bv,{href:"https://linkedin.com/in/surhak",target:"_blank",rel:"noopener noreferrer",children:(0,dt.jsx)(Ep,{size:i?18:20})}),(0,dt.jsx)(bv,{href:"https://github.com/surohak",target:"_blank",rel:"noopener noreferrer",children:(0,dt.jsx)(Sp,{size:i?18:20})}),(0,dt.jsx)(bv,{href:"https://t.me/surohak",target:"_blank",rel:"noopener noreferrer",children:(0,dt.jsx)(zp,{size:i?18:20})})]})]}),(0,dt.jsxs)(wv,{ref:t,as:ep.form,initial:{opacity:0,x:i?15:30},animate:{opacity:1,x:0},transition:{duration:i?.4:.5},onSubmit:e=>{if(e.preventDefault(),!n.from_name||!n.reply_to||!n.subject||!n.message)return s("error"),void setTimeout((()=>{s("idle")}),3e3);s("submitting");t.current&&ov("service_aadmhtt","template_bcmc59t",t.current,"mitFBwd43Ky99sQf6").then((e=>{console.log("Email successfully sent!",e.text),s("success"),r({from_name:"",reply_to:"",subject:"",message:""}),setTimeout((()=>{s("idle")}),3e3)})).catch((e=>{console.error("Failed to send email:",e),s("error"),setTimeout((()=>{s("idle")}),3e3)}))},children:[(0,dt.jsxs)(Sv,{children:[(0,dt.jsxs)(kv,{children:[(0,dt.jsx)(Ev,{htmlFor:"from_name",children:"Name"}),(0,dt.jsx)(Pv,{type:"text",id:"from_name",name:"from_name",value:n.from_name,onChange:l,required:!0,placeholder:"Your Name"})]}),(0,dt.jsxs)(kv,{children:[(0,dt.jsx)(Ev,{htmlFor:"reply_to",children:"Email"}),(0,dt.jsx)(Pv,{type:"email",id:"reply_to",name:"reply_to",value:n.reply_to,onChange:l,required:!0,placeholder:"Your Email"})]})]}),(0,dt.jsxs)(kv,{children:[(0,dt.jsx)(Ev,{htmlFor:"subject",children:"Subject"}),(0,dt.jsx)(Pv,{type:"text",id:"subject",name:"subject",value:n.subject,onChange:l,required:!0,placeholder:"Subject"})]}),(0,dt.jsxs)(kv,{children:[(0,dt.jsx)(Ev,{htmlFor:"message",children:"Message"}),(0,dt.jsx)(Tv,{id:"message",name:"message",value:n.message,onChange:l,required:!0,placeholder:"Your Message",rows:i?4:5})]}),(0,dt.jsx)(jv,{children:(0,dt.jsx)(Gp,{type:"submit",variant:"primary",size:i?"medium":"large",icon:(0,dt.jsx)(zp,{}),disabled:"submitting"===o,fullWidth:!0,children:"submitting"===o?"Sending...":"Send Message"})}),"success"===o&&(0,dt.jsx)(Av,{as:ep.div,initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:i?.3:.4},exit:{opacity:0,y:10},children:"Your message has been sent successfully!"}),"error"===o&&(0,dt.jsx)(Lv,{as:ep.div,initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:i?.3:.4},exit:{opacity:0,y:10},children:"There was an error sending your message. Please try again."})]})]})})]})},$v=()=>(0,dt.jsxs)(ht,{children:[(0,dt.jsx)(oi,{}),(0,dt.jsxs)(nt,{children:[(0,dt.jsx)(dh,{}),(0,dt.jsx)(fh,{}),(0,dt.jsx)("main",{children:(0,dt.jsxs)(Se,{children:[(0,dt.jsx)(be,{path:"/",element:(0,dt.jsx)(ff,{})}),(0,dt.jsx)(be,{path:"/about",element:(0,dt.jsx)(Xm,{})}),(0,dt.jsx)(be,{path:"/projects",element:(0,dt.jsx)(Rg,{})}),(0,dt.jsx)(be,{path:"/skills",element:(0,dt.jsx)(ev,{})}),(0,dt.jsx)(be,{path:"/contact",element:(0,dt.jsx)(Iv,{})})]})}),(0,dt.jsx)(hh,{})]})]}),Vv=e=>{e&&e instanceof Function&&n.e(453).then(n.bind(n,453)).then((t=>{let{getCLS:n,getFID:r,getFCP:i,getLCP:a,getTTFB:o}=t;n(e),r(e),i(e),a(e),o(e)}))};(()=>{let e=document.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",document.head.appendChild(e)),e.setAttribute("content","width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover")})();t.createRoot(document.getElementById("root")).render((0,dt.jsxs)(e.StrictMode,{children:[(0,dt.jsx)($v,{}),(0,dt.jsx)(c,{})]})),Vv()})()})();
//# sourceMappingURL=main.f048102f.js.map